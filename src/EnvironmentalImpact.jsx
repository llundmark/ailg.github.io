  ...
  return (
    <div className="page-canvas">
      <div className="page-content">
        ...
        <p>If history is any indication, what we don't know can hurt us. While we have some estimates and figures about the resources that the AI industry is consuming, there isn't nearly enough information made available. Multiple studies have made note of this discrepancy, for instance one analysis found that 84 percent of LLM use in May 2025 involved AI Models for which there has been no disclosure whatsoever about their environmental impact. Some of the figures and talking points circulating about AI's energy use can be traced back to industry-leader remarks which have no basis in fact.<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-17' } })}>[17]</button></p>

        <p>While there has been more cooperation from open-source AI companies such as Meta Llama in this regard, we need a better industry standard of transparency if we want to know for certain the cost of AI.<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-6' } })}>[18]</button></p>
        ...
        <p>This leads to the issue of Data Centers. All of the hardware used for AI needs to be housed somewhere, and so to meet the increased demand for AI tools, companies and governments are investing in the construction of many new Data Centers. As of 2025, there were about 4000 Data Centers in the U.S., with 3000 more planned or currently under construction.<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-19' } })}>[19]</button> Although this will provide work and jobs for many people, maintaining these Data Centers requires a massive amount of resources. According to the Electric Power Research Institute (EPRI), it is not unusual to see new data centers being built with energy needs of 100 to 1000 megawatts, roughly equivalent to powering between 80,000 to 800,000 households.<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-16' } })}>[16]</button></p>

        <p>In a study by the U.S. Government Accountability Office, researchers state “Training one large generative AI model can take tens of thousands of processors running for months and may cost several hundred million dollars.”<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-16' } })}>[16]</button> The energy cost of AI is not limited to training either. Queries from millions of users contribute to this, and researchers have estimated that a ChatGPT query consumes about five times more electricity than a simple web search. It's important to note that these electricity demands are typically met through fossil fuel-based power plants. While all machine-learning models must be trained, one issue unique to generative AI is the rapid fluctuations in energy use that occur over different phases of the training process. Power grid operators must have a way to absorb those fluctuations to protect the grid, and they usually employ diesel-based generators for that task.<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-20' } })}>[20]</button></p>

        <h2>Hardware and Water</h2>

        <p>For each new Data Center being built, there is a need for a massive amount of computer hardware for servers, data storage drives, and networking equipment. Large Data Centers typically contain at least 5000 servers. In 2025, a direct result of this demand for hardware was a shortage of components such as memory, hard drives and GPUs. Computers and gadgets were suddenly much more expensive, as these components doubled or tripled in price.<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-21' } })}>[21]</button><button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-22' } })}>[22]</button></p>

        <p>A point of concern with Data Centers which may not be readily apparent is the amount of water they use. Computer equipment generates a lot of heat while it is being used, especially in the case of GPUs. Chilled water is used to cool Data Centers by absorbing heat from computing equipment. It has been estimated that, for each kilowatt hour of energy a data center consumes, it would need two liters of water for cooling. Depending on where you live this might not sound like a big deal, but for cities and ecosystems prone to draught this can be a very important consideration.<button className="annotation" onClick={() => navigate('/cited-resources', { state:{ id:'cr-20' } })}>[20]</button></p>
